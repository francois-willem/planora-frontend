...
export default function HomeContent() {
  ...
  return (
    <>
          ...
          <div className="max-w-4xl mx-auto">
            <Reveal delay={0}>
              <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs sm:text-sm font-medium mb-6 sm:mb-8">
                ...
                <span className="hidden sm:inline">
                  Manage clients, sessions, and classes in one place
                </span>
            ...
            <Reveal delay={0.16}>
              <p className="text-base sm:text-lg lg:text-xl text-slate-600 dark:text-slate-300 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
                Manage classes, track attendance, handle cancellations, and keep instructor
                notes—all in one powerful, intuitive platform.
              </p>
            </Reveal>
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <Reveal delay={0.08}>
              <p className="text-base sm:text-lg lg:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto px-4 sm:px-0">
                Streamline your scheduling workflow with our comprehensive suite of tools
                designed for swim schools and educational institutions.
              </p>
            </Reveal>
          </div>
          ...
          >
            <RevealItem>
              <FeatureWrapper feature="client_profiles" requiredTier={TIERS.BASIC}>
                <div className="group bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-600 transform hover:-translate-y-2 h-full">
                  ...
                  <h4 className="text-lg sm:text-xl font-semibold mb-3 text-slate-900 dark:text-slate-100">
                    Client Login
                  </h4>
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                    Secure client portal where students can log in to confirm or cancel their
                    classes with ease.
                  </p>
                </div>
              </FeatureWrapper>
            ...
            <RevealItem>
              <FeatureWrapper feature="client_cancellations" requiredTier={TIERS.BASIC}>
                <div className="group bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-600 transform hover:-translate-y-2 h-full">
                  ...
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                    Intelligent system that allows cancelled lessons to be taken by other clients
                    as catch-up sessions.
                  </p>
                </div>
              </FeatureWrapper>
            </RevealItem>
            ...
            <RevealItem>
              <FeatureWrapper feature="class_scheduling" requiredTier={TIERS.BASIC}>
                <div className="group bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-600 transform hover:-translate-y-2 h-full">
                  ...
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                    Profiles and sessions are stored securely with real-time synchronization.
                  </p>
                </div>
              </FeatureWrapper>
            </RevealItem>
            ...
            <RevealItem>
              <FeatureWrapper feature="multiple_staff_accounts" requiredTier={TIERS.GROWTH}>
                <div className="group bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-600 transform hover:-translate-y-2 h-full">
                  ...
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                    Instructors can add detailed notes for each lesson, visible to admin and
                    optionally to clients.
                  </p>
                </div>
              </FeatureWrapper>
            </RevealItem>
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-r from-purple-600 to-indigo-700 dark:from-purple-700 dark:to-indigo-800">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <Reveal delay={0}>
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">
              Joining as Staff?
          ...
          <Reveal delay={0.08}>
            <p className="text-base sm:text-lg lg:text-xl text-purple-100 dark:text-purple-200 mb-6 sm:mb-8 max-w-2xl mx-auto px-4 sm:px-0">
              Register as an employee to join your organization&apos;s team. You&apos;ll need a business code from your administrator.
            </p>
          </Reveal>
          <Reveal delay={0.16}>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              {!user && (
                <>
                  <Link
                    ...
                    className="bg-white text-purple-600 px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-purple-50 transition-all duration-200 font-semibold text-base sm:text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 w-full sm:w-auto"
                  >
                    Register as Employee
                  </Link>
                  <Link
                    href="/login"
                    className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-white hover:text-purple-600 transition-all duration-200 font-semibold text-base sm:text-lg w-full sm:w-auto"
                  >
                    Login
                  </Link>
                </>
              ...
              {user && (
                <LogoutButton className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-white hover:text-purple-600 transition-all duration-200 font-semibold text-base sm:text-lg w-full sm:w-auto" />
              )}
            </div>
          </Reveal>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <Reveal delay={0.08}>
            <p className="text-base sm:text-lg lg:text-xl text-blue-100 dark:text-blue-200 mb-6 sm:mb-8 max-w-2xl mx-auto px-4 sm:px-0">
              Join swim schools and educational institutions already using Planora to streamline
              their operations.
            </p>
          </Reveal>
          <Reveal delay={0.16}>
